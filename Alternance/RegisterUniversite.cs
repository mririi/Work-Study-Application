...
{
    public partial class RegisterUniversite : Form
    {
        ...
        private void Register_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    SqlCommand cmd2 = new SqlCommand("insert into [Universite] (nom,adresse,IDUser) values (@nom,@adresse,@IDUser)", con);
                    ...
                    SqlDataAdapter cmd3 = new SqlDataAdapter("select ID from [Universite] where IDUser='" + dtable1.Rows[0][0].ToString() + "'", con);
                    DataTable dtable3 = new DataTable();
                    cmd3.Fill(dtable3);
                    SqlCommand cmd4 = new SqlCommand("update [User] set IDUni='" + dtable3.Rows[0][0].ToString() + "' where ID='" + dtable1.Rows[0][0].ToString() + "'", con);
